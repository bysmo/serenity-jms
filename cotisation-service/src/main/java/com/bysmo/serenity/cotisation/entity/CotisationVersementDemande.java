...
@Entity
@Table(name = "cotisation_versement_demandes")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class CotisationVersementDemande {
    ...
    @Builder.Default
    private VersementDemandeStatut statut = VersementDemandeStatut.EN_ATTENTE;

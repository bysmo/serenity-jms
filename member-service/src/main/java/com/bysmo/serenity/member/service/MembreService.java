...
import com.bysmo.serenity.member.dto.MembreDashboardResponse;
import com.bysmo.serenity.member.dto.MembreRegistrationRequest;
import com.bysmo.serenity.member.dto.MembreRequest;
import com.bysmo.serenity.member.dto.MembreResponse;
...
import com.bysmo.serenity.member.mapper.MembreMapper;
...
public class MembreService {
    ...
    public MembreResponse register(MembreRegistrationRequest request) {
        ...
        Membre membre = Membre.builder()
                ...
                .pinEnabled(false)
                .pinAttempts(0)
                .pinMode(com.bysmo.serenity.member.entity.enums.PinMode.EACH_TIME)
    ...
    public MembreDashboardResponse updateDashboard(UUID id) {
        ...
        BigDecimal totalCommissions = parrainageCommissionRepository.findByParrainId(id).stream()
                .filter(c -> c.getStatut() == com.bysmo.serenity.member.entity.enums.CommissionStatut.DISPONIBLE
                        || c.getStatut() == com.bysmo.serenity.member.entity.enums.CommissionStatut.EN_ATTENTE)
                .map(com.bysmo.serenity.member.entity.ParrainageCommission::getMontant)
